...
class Functions {	
	/*
		...
		<?php
			...
			include_once 'Linkar.Functions.Direct.XML/Functions.php';
	...
	*/
	static function GetVersion($credentialOptions,
		...
		return DirectFunctions::GetVersion($credentialOptions,
			DATAFORMAT_TYPE::XML, $receiveTimeout);
	}
	...
	*/
	...
	/*
		...
		---
	*/
	static function LkProperties($credentialOptions, $filename, $lkPropertiesOptions = null, $xmlFormat = XML_FORMAT::XML,
		$customVars = "", $receiveTimeout = 0) {

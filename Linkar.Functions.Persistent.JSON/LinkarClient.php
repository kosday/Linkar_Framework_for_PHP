...
class LinkarClient {
	...
	*/
	...
	/*
		...
		<?php
			...
			include_once 'Linkar.Functions.Persistent.JSON/LinkarClient.php';
	...
	*/
	public function GetVersion($receiveTimeout = 0) {
		return $this->linkarClient->GetVersion(DATAFORMAT_TYPE::JSON, $receiveTimeout);
	}
	...
	*/
	public function ResetCommonBlocks($receiveTimeout = 0) {
		return $this->linkarClient->ResetCommonBlocks(DATAFORMAT_TYPE::JSON, $receiveTimeout);
	}
}
?>

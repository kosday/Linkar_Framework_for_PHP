...
class TableOptions
{
	...
	*/
	public function LkSchemas($rowHeader = ROWHEADERS_TYPE::MAINLABEL, $rowProperties = false, $onlyVisibles = false, $usePropertyNames = false,
	...
	/*
		...
		Arguments:
			...
			$numPage - (number) For use with pagination, indicates the page number to obtain. Must be greater than 0.
	*/
	public function SqlMode($onlyVisibles = false, $applyConversion = false, $applyFormat = false, $calculated = false,
			$pagination = false, $regPage = 10, $numPage = 1) {
		$this->SchemaType = SCHEMA_TYPE::LKSCHEMAS;
		$this->SqlMode = true;
	...
	/*
		...
		Arguments:
			...
			$numPage - (number) For use with pagination, indicates the page number to obtain. Must be greater than 0.
	*/
	public function Dictionaries($rowHeader = ROWHEADERS_TYPE::MAINLABEL, $repeatValues = false, $applyConversion = false, $applyFormat = false, $calculated = false,
		$pagination = false, $regPage = 10, $numPage = 1) {
	...
	/*
		...
		Arguments:
			...
			$numPage - (number) For use with pagination, indicates the page number to obtain. Must be greater than 0.
	*/
	public function None($rowHeader = ROWHEADERS_TYPE::MAINLABEL, $repeatValues = false, 
			$pagination = false, $regPage = 10, $numPage = 1) {
		$this->SchemaType = SCHEMA_TYPE::NONE;
		$this->SqlMode = false;
		$this->RowHeader = $rowHeader;
		$this->RowProperties = false;
		$this->OnlyVisibles = false;

...
class LkPropertiesOptions
{
	...
	*/
	public function LkSchemas($rowHeader = ROWHEADERS_TYPE::MAINLABEL, $rowProperties = false, $onlyVisibles = false, $usePropertyNames = false, $pagination = false, $regPage = 10, $numPage = 1) {
		$this->SchemaType = SCHEMA_TYPE::LKSCHEMAS;
		$this->SqlMode = false;

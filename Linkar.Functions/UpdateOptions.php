...
class UpdateOptions {
	...
	*/
	...
	public function __construct($optimisticLockControl = false, $readAfter = false, $calculated = false, $conversion = false, $formatSpec = false, $originalRecords = false) {
	...
	*/
	...
	{
		$str = ($this->OptimisticLockControl ? "1" : "0") . DBMV_Mark::AM_str . $this->ReadAfterCommonOptions->GetStringAM();
		return $str;
	}
}
?>
